...
var stopwatch = {
  ...
  start: function() {
      ...
      if (!clockRunning) {
        ...
        clockRunning = true; //so you can't speed up the time
      }
  ...
  stop: function() {
    ...
    clockRunning = false; //makes so you can start again. 
  ...
  recordLap: function() {
      ...
      $("#laps").append('<p>Lap + stopwatch.lap + ":" + stopwatch.time</p>'); //this one still broken
